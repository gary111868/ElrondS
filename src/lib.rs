...
#[derive(Debug)]
pub struct ElrondSDKProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ElrondSDKProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ElrondSDK processing");
    
    let mut processor = ElrondSDKProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ElrondSDKProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ElrondSDKProcessor::new(false);
